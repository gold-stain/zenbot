...
const Dashboard: React.FC = () => {
  ...
  const announcements = [
    { title: "Q1 2026 review cycle opens Mar 1", time: "2h ago", tag: "HR" },
    { title: "New WFH policy published for India region", time: "Yesterday", tag: "Policy" },
    { title: "Office maintenance: Mumbai HO, this weekend", time: "2d ago", tag: "Facilities" },
  ];
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[11px] text-white/40 flex items-center gap-1 mt-0.5">
                      <Clock className="h-3 w-3" /> {i === 0 ? "Today" : i === 1 ? "Yesterday" : "Last week"}
                    </div>
                  </div>
                </div>
        ...
        <div className="rounded-2xl border border-white/5 bg-[#0B0B20]/80 backdrop-blur-md p-6">
          ...
          <div className="space-y-4">
            {announcements.map((a, i) => (
              <div key={i} className="pb-4 border-b border-white/5 last:border-0 last:pb-0" data-testid={`announcement-${i}`}>
