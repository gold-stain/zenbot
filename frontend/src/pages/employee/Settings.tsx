      ...
      <div className="max-w-3xl space-y-5">
        <Section title="Voice">
          <Row label="Text-to-speech (read replies aloud)">
            <Switch checked={tts} onCheckedChange={setTts} data-testid="settings-tts" />
          </Row>
          <Row label="Voice">
          ...
          <Row label={`Playback speed (${speed[0].toFixed(1)}x)`}>
            <Slider value={speed} min={0.5} max={2} step={0.1} onValueChange={setSpeed} className="w-56" data-testid="settings-speed" />
          </Row>
        </Section>
        ...
        <Section title="Notifications">
          <Row label="Email notifications">
            <Switch checked={emailNotif} onCheckedChange={setEmailNotif} data-testid="settings-email" />
          </Row>
          <Row label="In-app notifications">
            <Switch checked={pushNotif} onCheckedChange={setPushNotif} data-testid="settings-push" />
          </Row>
        </Section>
        ...
        <div className="flex justify-end pt-2">
          <Button
            ...
            className="bg-gradient-to-r from-[#FF6B5B] to-[#E11D2C] text-white hover:brightness-110 transition-all rounded-xl px-6"
          >
            Save preferences
          </Button>
        </div>
